...
/**
 * @author Paulo Caselli
 */
public class LiveChatDynamicInclude extends ProviderDynamicInclude {

	public LiveChatDynamicInclude(String providerAccountToken, User user) {
	...
	private static final String _MAIN_TEMPLATE_CLASSPATH_PATH =
		"/template/livechat-template.html";
